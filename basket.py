...
#basket
handle_outside = Cylinder(vec([0.4,.1,-1]),0.5,0.5,vec([.1,0,0]),brown)
handle_inside = Cylinder(vec([0.4,.1,-1]),0.45,0.45,vec([.1,0,0]),brown)
cut_handle = Parallelepiped(vec([0.4,-.9,-1.5]),vec([2,0,0]),vec([0,1,0]),vec([0,0,2]),brown)
...
right_cylinder = Cylinder(vec([0.5,-.4,-1]),0.5,0.5,vec([0,0.6,0]),brown)
middle = Parallelepiped(vec([0.2,-0.4,-1.5]),vec([.3,0,0]),vec([0,0.6,0]),vec([0,0,1]),brown)
left_cylinder = Cylinder(vec([0.2,-.4,-1]),0.5,0.5,vec([0,0.6,0]),brown)
...
right_cylinder_inside = Cylinder(vec([0.45,-.35,-1]),0.4,0.4,vec([0,0.55,0]),brown)
middle_inside = Parallelepiped(vec([0.2,-0.35,-1.5]),vec([.25,0,0]),vec([0,0.55,0]),vec([0,0,.95]),brown)
left_cylinder_inside = Cylinder(vec([0.25,-.35,-1]),0.4,0.4,vec([0,0.55,0]),brown)
